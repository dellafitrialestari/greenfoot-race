 ...
 */
public class delman extends animasi{
    int delay=5;
    int x;
    int img=0;
    public delman(){
    ...
    public void act(){
        ...
        if(or != null && ((awal)getWorld()).cekNilai()<=1000){
            ((awal)getWorld()).gameOver();
        }
        else if (or !=null && ((awal)getWorld()).cekNilai()>1000){
            ((awal)getWorld()).menang();
        }
