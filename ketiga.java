...
/**
 * Write a description of class ketiga here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class ketiga extends World
{
    ...
    public void gerak(){
        if(System.currentTimeMillis() >= nextTime){
            //Agar blok muncul
            c++;
            addObject(new Block3(), Greenfoot.getRandomNumber(getWidth()-150)+50, 0);
            nextTime = System.currentTimeMillis() + Greenfoot.getRandomNumber(500);
            if(c==240){
        ...
        if (str != null) {  
            ...
            for (Object obj : getObjects(Block3.class)) {  
                ((Block3) obj).checkKey(str);  
