...
public class awal extends World
{
    ...
    public void gerak(){
        if(System.currentTimeMillis() >= nextTime){
            //Agar blok muncul
            c++;
            addObject(new Block(), Greenfoot.getRandomNumber(getWidth()-150)+50, 0);
            nextTime = System.currentTimeMillis() + Greenfoot.getRandomNumber(2000);
            if(c==60){
