 ...
 */
public class delman3 extends animasi
{
    int delay=5;
    int x;
    int img=0;
    ...
    public void act() 
    {
        ...
        if(or != null && ((ketiga)getWorld()).cekNilai()<=2000){
            ((ketiga)getWorld()).gameOver();
        }
        else if (or !=null && ((ketiga)getWorld()).cekNilai()>2000){
            ((ketiga)getWorld()).menang();
        }
